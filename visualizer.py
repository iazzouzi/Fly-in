...
class Window(arcade.Window):
    ...
    Attributes:
        graph: The network graph being visualized.
        turns: List of simulation turns with movement data.
        counter: Current turn number in the simulation.
        play: Flag indicating if simulation is playing.
        camera: Camera for panning the visualization.
        gui_camera: Camera for fixed UI elements.
    """
    ...
    def __init__(
        ...
        """Initializes the graphical visualization window
        ...
        Args:
            ...
            TURNS (list[list[dict[str, list[Drone] | Zone | int]]]): The
                sequential list of movement instructions generated by the
                engine.
        """
    ...
    def on_update(self, delta_time: float) -> None:
        ...
        if self.player:
            ...
            self.player = None
        if self.counter == self.graph.nb_drones:
            self.play = False
            self.counter = 0
            self.turn = self.turns[self.counter]
...
class Visualizer:
    ...
    def run(
        ...
        Args:
            ...
            HIGHT (int): The height of the window in pixels.
